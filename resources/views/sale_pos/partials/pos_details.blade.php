                            ...
                            <td>
                                <div class="{{$col}} col-xs-6 d-inline-table">
                                    ...
                                    <span class="@if(!$is_discount_enabled && !$is_rp_enabled) hide @endif">
                                        ...
                                        <br/>
                                        	<i class="fas fa-pen cursor-pointer" id="pos-edit-discount" title="@lang('sale.edit_discount')" aria-hidden="true" data-toggle="modal" data-target="#posEditDiscountModal"></i><span id="total_discount">0</span>
                        ...
                        <tr>
                            <td>
                                <div class="col-sm-2 col-xs-6 col-2px-padding">
                                    <button type="button" class="btn btn-warning btn-block btn-flat @if($pos_settings['disable_draft'] != 0) hide @endif btn-lg" id="pos-draft" style="font-size: 50px;">@lang('sale.draft')</button>
                                    <button type="button" class="btn btn-info btn-block btn-flat btn-lg" id="pos-quotation" style="font-size: 50px;">@lang('lang_v1.quotation')</button>
                                    @if(!empty($pos_settings['show_credit_sale_button']))
                                        <button type="button" class="btn bg-purple btn-block btn-flat no-print pos-express-finalize" data-pay_method="credit_sale" title="@lang('lang_v1.tooltip_credit_sale')" style="font-size: 50px;">
                                    ...
                                    @else
                                        <button type="button" class="btn bg-maroon btn-block btn-flat no-print @if(!empty($pos_settings['disable_suspend'])) pos-express-btn btn-lg @endif pos-express-finalize @if(!array_key_exists('card', $payment_types)) hide @endif" data-pay_method="card" title="@lang('lang_v1.tooltip_express_checkout_card')" style="font-size: 50px;">
                                            <div class="text-center">
                                                <i class="fa fa-check" aria-hidden="true"></i>
                                    ...
                                    @if(empty($pos_settings['disable_suspend']))
                                        <button type="button" class="btn bg-red btn-block btn-flat no-print pos-express-finalize" data-pay_method="suspend" title="@lang('lang_v1.tooltip_suspend')" style="font-size: 50px;">
                                            <div class="text-center">
                                    ...
                                    @endif
                                    <button type="button" class="btn bg-navy btn-block btn-flat btn-lg no-print @if($pos_settings['disable_pay_checkout'] != 0) hide @endif pos-express-btn" id="pos-finalize" title="@lang('lang_v1.tooltip_checkout_multi_pay')" style="font-size: 50px;">
                                        <div class="text-center">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                            <b>@lang('lang_v1.checkout_multi_pay')</b>
                                        </div>
                                    </button>
                                    <button type="button" class="btn btn-success btn-block btn-flat btn-lg no-print @if($pos_settings['disable_express_checkout'] != 0 || !array_key_exists('cash', $payment_types)) hide @endif pos-express-btn pos-express-finalize" data-pay_method="cash" title="@lang('tooltip.express_checkout')" style="font-size: 50px;">
                                        <div class="text-center">
                                            <i class="fa fa-check" aria-hidden="true"></i>
