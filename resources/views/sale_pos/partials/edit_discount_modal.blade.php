		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row @if(!$is_discount_enabled) hide @endif">
					<div class="col-md-12">
						<h1 class="modal-title">@lang('sale.edit_discount'):</h1>
					</div>
					<div class="col-md-6">
				        <div class="form-group">
				            ...
				            <div class="input-group">
				                ...
				                {!! Form::select('discount_type_modal', ['fixed' => __('lang_v1.fixed')], 'fixed', ['class' => 'form-control', 'placeholder' => __('messages.please_select'), 'required']); !!}
				            </div>
				        </div>
				    </div>
				    <div class="col-md-6">
